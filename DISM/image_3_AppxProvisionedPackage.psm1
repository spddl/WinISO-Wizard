function image_3_AppxProvisionedPackage {
    ...
    Get-AppxProvisionedPackage -Path "$RootDir\extractWIMImage" | where-object {
        $_.DisplayName -ne "Microsoft.XboxGameOverlay" -and `
        ...
        $_.DisplayName -notlike "Microsoft.WindowsAlarms_*" -and `
        $_.DisplayName -notlike "Microsoft.WindowsCalculator_*" -and `
    ...
    Get-WindowsCapability -Path "$RootDir\extractWIMImage" | where-object {
        ...
        (
            ...
            $_.Name -like "Browser.InternetExplorer*" -or `
